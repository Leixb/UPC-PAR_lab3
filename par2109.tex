...
\begin{figure}[H]
\centering
\includegraphics[width=8cm, height=2cm]{plots/dependency_graph_mandel_point.png}
%con esto los deformas yaya queria ver como quedaba
...
\begin{figure}[H]
\centering
% pero con esto los deformas
\includegraphics[width=8cm, height=2cm]{plots/dependency_graph_mandel_row.pdf}
\caption{Task dependence graph of \texttt{mandel-tar.c} with row decomposition.}
\label{graph:mandel_row}
\end{figure}

% queda tope feo
% se ven super borrosos los de mandel
% ya pork los he escalado a 100px de ancho
% para los verticales funciona, pero para los horizontales como que no
% pero esos tambien te daban problems? solo el primero
% que numero de piceles pongo?
% 500 de alto en los horizontales? idk sincerely
\begin{figure}[H]
\centering
%pero te falla el raro, o? el otro con pdf ya sirve? ya sirve
% falla el de point en los dos casos
% vale vale, entones solo metos los del point con png 
% perf
\includegraphics[width=2cm, height=8cm]{plots/dependency_graph_mandeld_point.png}
...
% LOL usa height
% rip
\includegraphics[width=2cm, height=8cm]{plots/dependency_graph_mandeld_row.pdf}
